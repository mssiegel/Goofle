...
exports.cutestBaby = function (inputImage, inputName) {
 return `
          <!DOCTYPE html>
          <html lang="en">
          <head>
          ...
          <body>
            <div id="grey-header1">
              ...
              <input id="search-form" type="text" value="who is the world's cutest baby?">
              <div id="search-icon">
            ...
            <p class="purple-title">${inputName} - Wins World's Cutest Baby Award</p>
            <p class="green-link">https://www.babiesinternational.com/results-of-cutest-baby-contest</p>
            <img src="${inputImage}" class="small-image">
            <p class="summary-text">Over 28,000 babies were entered into the contest. Of them all, ${inputName} stood out as the cutest and most adoreable. Over a 1,000 people were chanting "${inputName}!! ${inputName}!! ${inputName}!!!"  "My heart melted at the sight of ${inputName}," said a teary-eyed Dwayne "The Rock" Johnson...</p>
            ...
            <p class="summary-text">Famous people took to Twitter to congratulate ${inputName}. A certain president tweeted "Wow, ${inputName} has a cuter hairstyle than I do!!!! So incredible!!"</p>

            <p class="title">Cuter than a Cute Cutie?</p>
            <p class="green-link">www.cuteandfunny.com/2018/you-gotta-love-that-baby</p>
            <p class="summary-text">Goodness gracious ${inputName}!!! As in zoinks! Like howdy duty! Yowzies! Um, oh my gawwwwd! Those are like da only words to describe ${inputName}...Good times for all...</p>
