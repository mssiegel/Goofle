...
exports.smelliestFarter = function (inputImage, inputName) {
 return `
          <!DOCTYPE html>
          <html lang="en">
          <head>
          ...
          <body>
            <div id="grey-header1">
              ...
              <input id="search-form" type="text" value="who is the world's smelliest farter?">
              <div id="search-icon">
            ...
            <p id="number-of-results">About 9,350,000 results (0.29 seconds)</p>


            <p class="purple-title">${inputName} - The World's Smelliest Farter</p>
            <p class="green-link">https://www.fartingwithmanners.com/results-of-smelliest-farter-contest</p>
            <img src="${inputImage}" class="small-image">
            <p class="summary-text">Over 15,000 people entered the contest. Of them all, ${inputName} stood out as being the loudest and smelliest farter. Over a 1,000 people were chanting "${inputName}!! ${inputName}!! ${inputName}!!!"  "Smelling ${inputName}'s farts made my nose melt off," said a teary-eyed Dwayne "The Rock" Johnson...</p>
            ...
            <p class="summary-text">Famous people took to Twitter to congratulate ${inputName}. A certain president tweeted "Wow, ${inputName} has a smellier fart than I do!!!! So incredible!!"</p>
